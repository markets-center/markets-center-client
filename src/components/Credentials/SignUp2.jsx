...
import {Button, FormControlLabel, Input, Switch, TextField, Typography} from "@mui/material";
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Input
                        ...
                        variant="standard"
                         onChange={handleChange}
                    />
                    <label className={css.label} htmlFor="">Confirmar contraseña</label>
                    <Input
                        className={css.input}
                        margin="normal"
                        required
                    ...
                    >
                        <GoogleIcon fontSize="small" />&nbsp; Registrarse con Google
                    </Button>
                </form>
